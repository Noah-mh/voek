...
import Modal from "../SearchResults/Modal";
    ...
    <div>
      <div className="w-full max-w-sm bg-gray-50 border rounded-lg shadow-xl p-2 m-2">
        ...
        <div className="px-5 pb-5">
          <Link to={`/productDetailsWithReviews/${product.product_id}`}>
            <h5 className="text-xl text-ellipsis overflow-hidden whitespace-nowrap w-full font-semibold tracking-tight text-greyAccent hover:text-lighterGreyAccent hover:cursor-pointer">
              {product.name}
            </h5>
          </Link>
