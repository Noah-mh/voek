...
exports.handleCartDetails = exports.handlesGetProductsUsingCategory = exports.handlesInsertLastViewedProduct = exports.handlesGetProductCat = exports.handlesGetProductVariationImage = exports.handlesGetProductImage = exports.handlesGetProductVariationsPricing = exports.handlesGetProductVariations = exports.handlesGetAllListedProducts = exports.handlesCheckWishlistProductExistence = exports.handleProductReviews = exports.handleProductDetailsWithoutReviews = exports.handlesDeletingWishlistedProduct = exports.handlesInsertingWishlistedProduct = exports.handlesProductsBasedOnCategory = exports.handlesSearchResult = exports.handlesSearchBarPredictions = exports.handlesTopProducts = exports.handlesGetLastViewed = exports.handlesGetLastViewedProductExistence = exports.handlesGetWishlistItems = exports.handlesGetRecommendedProductsBasedOnCatWishlist = exports.handlesGetRecommendedProductsBasedOnCat = exports.handleAddToCart = exports.handlesGetCartDetails = exports.handlesGetProductDetails = void 0;
...
const handleAddToCart = async (quantity, customer_id, product_id, sku) => {
    const promisePool = database_1.default.promise();
    const connection = await promisePool.getConnection();
    let insertId;
    try {
        ...
        if (err.errno === 1062) {
            ...
            try {
                ...
                insertId =
                    result.affectedRows > 0 ? product_id : 0;
            }
            catch (err) {
                console.error(err);
                throw new Error(err);
...
const handlesGetRecommendedProductsBasedOnCatWishlist = async (category_id) => {
    const promisePool = database_1.default.promise();
    const connection = await promisePool.getConnection();
    const sql = `SELECT products.product_id , products.name, products.description
  FROM category, products 
...
exports.handlesGetRecommendedProductsBasedOnCatWishlist = handlesGetRecommendedProductsBasedOnCatWishlist;
...
const handlesGetLastViewedProductExistence = async (customer_id, product_id, timezone, date_viewed) => {
    const promisePool = database_1.default.promise();
    const connection = await promisePool.getConnection();
...
exports.handlesGetLastViewedProductExistence = handlesGetLastViewedProductExistence;
const handlesGetLastViewed = async (customer_id, timezone, date_viewed) => {
    const promisePool = database_1.default.promise();
    const connection = await promisePool.getConnection();
    const sql = `SELECT products.product_id, products.name, products.description
  FROM last_viewed
...
const handlesGetProductVariations = async (productId) => {
    const promisePool = database_1.default.promise();
    const connection = await promisePool.getConnection();
...
exports.handlesGetProductVariations = handlesGetProductVariations;
const handlesGetProductVariationsPricing = async (productId) => {
    const promisePool = database_1.default.promise();
    const connection = await promisePool.getConnection();
...
exports.handlesGetProductVariationsPricing = handlesGetProductVariationsPricing;
const handlesGetProductImage = async (productId) => {
    const promisePool = database_1.default.promise();
    const connection = await promisePool.getConnection();
...
exports.handlesGetProductImage = handlesGetProductImage;
const handlesGetProductVariationImage = async (sku) => {
    const promisePool = database_1.default.promise();
    const connection = await promisePool.getConnection();
...
exports.handlesGetProductVariationImage = handlesGetProductVariationImage;
const handlesGetProductCat = async (productId) => {
    const promisePool = database_1.default.promise();
    const connection = await promisePool.getConnection();
...
exports.handlesGetProductCat = handlesGetProductCat;
const handlesInsertLastViewedProduct = async (productId, customerId, currentDate, timezone) => {
    const promisePool = database_1.default.promise();
    const connection = await promisePool.getConnection();
    const categories = await (0, exports.handlesGetProductCat)(productId);
    const categoryId = categories.length > 0 ? categories[0].categoryId : 0;
    const found = await (0, exports.handlesGetLastViewedProductExistence)(customerId, productId, timezone, currentDate);
    if (found.length === 0) {
...
exports.handlesInsertLastViewedProduct = handlesInsertLastViewedProduct;
const handlesGetProductsUsingCategory = async (categoryId) => {
    const promisePool = database_1.default.promise();
    const connection = await promisePool.getConnection();
...
exports.handlesGetProductsUsingCategory = handlesGetProductsUsingCategory;
//Noah
const handleCartDetails = async (customer_id, sku) => {
    const promisePool = database_1.default.promise();
    const connection = await promisePool.getConnection();
...
exports.handleCartDetails = handleCartDetails;
